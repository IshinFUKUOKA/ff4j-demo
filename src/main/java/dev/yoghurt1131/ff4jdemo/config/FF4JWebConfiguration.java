...
public class FF4JWebConfiguration extends SpringBootServletInitializer {
    ...
    @Bean
    public ServletRegistrationBean ff4jWebConsole(FF4jDispatcherServlet servlet)
    {
        ServletRegistrationBean servletBean = new ServletRegistrationBean(servlet, "/ff4j-web-console/*");
        servletBean.setName("ff4j-console");
